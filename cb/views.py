...
from cb.models import Complaint, Profile, Comment, ComplaintFavorite
...
def index(request):
    ...
    verified_count = Profile.objects.filter(verified=True).count()
...
def my_complaints(request):
    ...
    return render(request, 'my-complaints.html', {'complaints': complaints, 'complaints_sorted': complaints_sorted,
                                                  'complaints_footer': complaints_footer, 'complaint_count': complaint_count, 'contacts': contacts})
    # else:
    #     return render(request, 'my-complaints.html', {'complaints': complaints, 'complaints_sorted': complaints_sorted,
    #                                                   'complaints_footer': complaints_footer,
